...
public class Bills {
	...
	public void denominations() {
		if (register[0] != 0) {
			System.out.println("$100 - " + register[0]);
		}
		if (register[1] != 0) {
			System.out.println("$50 - " + register[1]);
		}
		if (register[2] != 0) {
			System.out.println("$20 - " + register[2]);
		}
		if (register[3] != 0) {
			System.out.println("$10 - " + register[3]);
		}
		if (register[4] != 0) {
			System.out.println("$5 - " + register[4]);
		}
		if (register[5] != 0) {
			System.out.println("$1 - " + register[5]);
		}
	}
